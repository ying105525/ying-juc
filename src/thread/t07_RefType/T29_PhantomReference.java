 ...
 * @version 1.0.0
 */
public class T29_PhantomReference {

    private static final List<Object> LIST = new LinkedList<>();
    private static final ReferenceQueue<MForFinalize> QUEUE = new ReferenceQueue<>();
    ...
    public static void main(String[] args) {
        ...
        PhantomReference<MForFinalize> phantomReference = new PhantomReference<>(new MForFinalize(), QUEUE);
        ...
        new Thread(() -> {
            while (true) {
                Reference<? extends MForFinalize> poll = QUEUE.poll();
                if (poll != null) {
